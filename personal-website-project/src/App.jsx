...
function App() {
  ...
  if(isPending) return <div className="dark:bg-[#252128] dark:text-[#AEBCCF] text-title font-bold text-5xl w-screen h-screen flex justify-center items-center">Loading...</div>
