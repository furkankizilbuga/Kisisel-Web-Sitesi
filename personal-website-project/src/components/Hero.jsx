        ...
        <main className="flex lg:justify-between flex-row mt-20 gap-2 max-[1200px]:flex-col-reverse">
            <div className="flex flex-col gap-10 max-w-2xl">
                ...
                <div className="flex gap-3">
                    ...
                    <a href="https://github.com/furkankizilbuga" target="_blank" className="transition cursor-pointer gap-1 flex items-center border rounded-lg font-medium px-5 text-main-purple bg-transparent border-main-purple hover:bg-main-purple hover:text-white dark:bg-[#383838] dark:text-[#E1E1FF] dark:border-[#E1E1FF] dark:hover:bg-[#E1E1FF] dark:hover:text-black"><i className="dark:text-[#BAB2E7]" /><FontAwesomeIcon icon={faGithub} />Github</a>
                    <a href="https://www.linkedin.com/in/furkan-k%C4%B1z%C4%B1lbu%C4%9Fa-8b0bb8278/" target="_blank" className="gap-1 transition cursor-pointer flex items-center border rounded-lg font-medium px-5 text-main-purple bg-transparent border-main-purple hover:bg-main-purple hover:text-white dark:bg-[#383838] dark:text-[#E1E1FF] dark:border-[#E1E1FF] dark:hover:bg-[#E1E1FF] dark:hover:text-black"><i className="dark:text-[#BAB2E7]" /><FontAwesomeIcon icon={faLinkedinIn} />Linkedin</a>
                </div>
            </div>
